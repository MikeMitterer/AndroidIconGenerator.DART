...
void init_autogenerated() {
  ...
  autogenerated_html.FormElement __settings;
  
  autogenerated_html.InputElement __foregroundColor;
  
  autogenerated_html.InputElement __backgroundColor;
  ...
  autogenerated_html.DivElement __preview;
  ...
  // Initialize fields.
  __settings = _root.query('#settings');
  __foregroundColor = __settings.query('#foregroundColor');
  __backgroundColor = __settings.query('#backgroundColor');
  __dropZone = _root.query('#drop-zone');
  __read = _root.query('#read');
  __file = __read.query('#file');
  __preview = _root.query('#preview');
  __filelist = __preview.query('#filelist');
  ...
  __stoppers1.add(autogenerated.watchAndInvoke(() => convertedfiles.files, (_) {
    ...
    for (var file in convertedfiles.files) {
      ...
      autogenerated_html.Element __e4;
      ...
      __stoppers2_1.add(autogenerated.watchAndInvoke(() => file.isImage, (__e) {
        ...
        if (_isVisible__e4 && !showNow) {
          ...
          __stoppers3_2_1 = [];
          autogenerated.insertAllBefore(__e4.parentNode, __e4.nextNode,
