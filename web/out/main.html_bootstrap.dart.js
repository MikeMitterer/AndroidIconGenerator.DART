...
$$.DoubleLinkedQueue = {"":"Object;_sentinel",
 ...
 forEach$1: function(f) {
  ...
  for (; !(entry === this._sentinel); entry = nextEntry) {
    ...
    f.call$1(entry.get$_liblib1$_element());
  }
},
 filter$1: function(f) {
  ...
  for (t1 = $.getInterceptor$JSArray(other); !(entry === this._sentinel); entry = nextEntry) {
    nextEntry = entry.get$_next();
    if (f.call$1(entry.get$_liblib1$_element()) === true)
      t1.addLast$1(other, entry.get$_liblib1$_element());
  }
  return other;
},
 iterator$0: function() {
...
$$.AndroidFile = {"":"Object;_file,filename>,src=,width<,height<,isImage=",
 AndroidFile$1: function(_file) {
  var t1, t2, reader;
  t1 = this._file;
  this.filename = $.htmlEscape(t1.get$name());
  t2 = t1.get$type();
  if ($.getInterceptor$JSString(t2).startsWith$1(t2, "image") === true) {
    reader = $.FileReader_FileReader();
    t2 = reader.get$on().get$load();
    $.getInterceptor$JSArray(t2).add$1(t2, new $.anon2(reader, this));
    reader.readAsDataUrl$1(t1);
  }
}
};

$$.ConvertedFiles = {"":"Object;files>"
};

$$.DndFiles = {"":"Object;_readForm,_fileInput>,_dropZone>",
 ...
 get$_onDragOver: function() {
  return new $.BoundClosure0(this, '_onDragOver$1');
},
 _onDrop$1: function(event$) {
  event$.stopPropagation$0();
  event$.preventDefault$0();
  this._dropZone.get$classes().remove$1("hover");
  this._readForm.reset$0();
  this._addSelectedFilesToModel$1(event$.get$dataTransfer().get$files());
},
 get$_onDrop: function() {
  return new $.BoundClosure0(this, '_onDrop$1');
},
 _addSelectedFilesToModel$1: function(files) {
  var t1, t2, t3;
  t1 = $.get$convertedfiles().get$files();
  $.getInterceptor$JSArray(t1).clear$0(t1);
  for (t1 = $.getInterceptor$JSArray(files).iterator$0(files); t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    t3 = $.get$convertedfiles().get$files();
    $.getInterceptor$JSArray(t3).add$1(t3, $.AndroidFile$(t2));
  }
  $.dispatch();
},
 DndFiles$0: function() {
  this._readForm = $.document().query$1("#read");
  this._fileInput = $.document().query$1("#file");
  var t1 = this._fileInput.get$on().get$change();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.anon(this));
  this._dropZone = $.document().query$1("#drop-zone");
  t1 = this._dropZone.get$on().get$dragOver();
  $.getInterceptor$JSArray(t1).add$1(t1, this.get$_onDragOver());
  t1 = this._dropZone.get$on().get$dragEnter();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.anon0(this));
  t1 = this._dropZone.get$on().get$dragLeave();
  $.getInterceptor$JSArray(t1).add$1(t1, new $.anon1(this));
  t1 = this._dropZone.get$on().get$drop();
  $.getInterceptor$JSArray(t1).add$1(t1, this.get$_onDrop());
}
};

$$.init_autogenerated_anon = {"":"Closure;",
 call$0: function() {
  return $.get$convertedfiles().get$files();
}
};

$$.init_autogenerated_anon0 = {"":"Closure;box_1,_removeChild__e5_2",
 call$1: function(_) {
  var t1, t2, t3, __insert___e5, t4, t5, t6, t7, t8, t9, _endPosition__e5;
  for (t1 = this._removeChild__e5_2, t2 = $.getInterceptor$JSArray(t1), t3 = t2.iterator$0(t1); t3.get$hasNext() === true;)
    t3.next$0().call$0();
  t2.clear$0(t1);
  t3 = this.box_1;
  t3._endPosition__e5_10 = $.removeNodes(t3.__e5_9, t3._endPosition__e5_10);
  __insert___e5 = t3.__e5_9.get$nextNode();
  for (t4 = $.get$convertedfiles().get$files(), t4 = $.getInterceptor$JSArray(t4).iterator$0(t4); t4.get$hasNext() === true;) {
    t5 = {};
    t6 = t4.next$0();
    t5.__e4_0 = null;
    t5.__binding0_1 = null;
    t5.__stoppers2_1_2 = null;
    t5.__e3_3 = null;
    t5._endPosition__e3_4 = null;
    t5._isVisible__e3_5 = false;
    t5.__e1_6 = null;
    t5.__stoppers3_2_1_7 = null;
    t5.__binding2_8 = null;
    t5.__e4_0 = $.LIElement_LIElement();
    t5.__binding0_1 = $.Text_Text("");
    t5.__stoppers2_1_2 = [];
    t5.__e3_3 = $.Element_Element$html("<template style=\"display:none\"></template>");
    t7 = t5.__e4_0.get$nodes();
    $.getInterceptor$JSArray(t7).add$1(t7, t5.__binding0_1);
    t7 = t5.__e4_0.get$nodes();
    $.getInterceptor$JSArray(t7).add$1(t7, $.Text_Text("\n        "));
    t7 = t5.__e4_0.get$nodes();
    $.getInterceptor$JSArray(t7).add$1(t7, t5.__e3_3);
    t7 = t5.__e4_0.get$nodes();
    $.getInterceptor$JSArray(t7).add$1(t7, $.Text_Text("\n        "));
    t7 = t3.__e5_9.get$parent();
    t8 = $.Text_Text("\n        ");
    t9 = t5.__e4_0;
    _endPosition__e5 = $.Text_Text("\n      ");
    t3._endPosition__e5_10 = _endPosition__e5;
    $.insertAllBefore(t7, __insert___e5, [t8, t9, _endPosition__e5]);
    t7 = t5.__stoppers2_1_2;
    $.getInterceptor$JSArray(t7).add$1(t7, $.watchAndInvoke(new $.init_autogenerated__anon(t6), new $.init_autogenerated__anon0(t5, t6), null));
    t5._endPosition__e3_4 = t5.__e3_3;
    t7 = t5.__stoppers2_1_2;
    $.getInterceptor$JSArray(t7).add$1(t7, $.watchAndInvoke(new $.init_autogenerated__anon1(t6), new $.init_autogenerated__anon2(t5, t6), null));
    t2.add$1(t1, new $.init_autogenerated__anon3(t5));
  }
}
};

$$.init_autogenerated__anon = {"":"Closure;file_3",
 call$0: function() {
  return $.S(this.file_3.get$filename());
}
};

$$.init_autogenerated__anon0 = {"":"Closure;box_0,file_4",
 call$1: function(__e) {
  var t1, t2;
  t1 = this.file_4.get$filename();
  t2 = this.box_0;
  t2.__binding0_1 = $.updateBinding(t1, t2.__binding0_1, __e.get$newValue());
}
};

$$.init_autogenerated__anon1 = {"":"Closure;file_5",
 call$0: function() {
  return this.file_5.get$isImage();
}
};

$$.init_autogenerated__anon2 = {"":"Closure;box_0,file_6",
 call$1: function(__e) {
  var showNow, t1, t2, t3, t4, t5, t6, t7, t8, _endPosition__e3, t9;
  showNow = __e.get$newValue();
  t1 = this.box_0;
  t2 = t1._isVisible__e3_5 === true;
  if (t2 && showNow !== true) {
    t1._isVisible__e3_5 = false;
    t2 = t1.__stoppers3_2_1_7;
    t3 = $.getInterceptor$JSArray(t2);
    t3.forEach$1(t2, new $.init_autogenerated___anon1());
    t3.clear$0(t2);
    t1.__e1_6 = null;
    t1.__binding2_8 = null;
    t1._endPosition__e3_4 = $.removeNodes(t1.__e3_3, t1._endPosition__e3_4);
  } else if (!t2 && showNow === true) {
    t1._isVisible__e3_5 = true;
    t1.__e1_6 = $.ImageElement_ImageElement(null, null, null);
    t1.__stoppers3_2_1_7 = [];
    t1.__binding2_8 = $.Text_Text("");
    t2 = t1.__e3_3.get$parent();
    t3 = t1.__e3_3.get$nextNode();
    t4 = $.Text_Text("\n          ");
    t5 = t1.__e1_6;
    t6 = $.BRElement_BRElement();
    t7 = $.Text_Text("\n          Source: ");
    t8 = t1.__binding2_8;
    _endPosition__e3 = $.Text_Text("\n         ");
    t1._endPosition__e3_4 = _endPosition__e3;
    $.insertAllBefore(t2, t3, [t4, t5, t6, t7, t8, _endPosition__e3]);
    t3 = t1.__stoppers3_2_1_7;
    t2 = $.getInterceptor$JSArray(t3);
    t9 = this.file_6;
    t2.add$1(t3, $.watchAndInvoke(new $.init_autogenerated___anon2(t9), new $.init_autogenerated___anon3(t1), null));
    t3 = t1.__stoppers3_2_1_7;
    $.getInterceptor$JSArray(t3).add$1(t3, $.watchAndInvoke(new $.init_autogenerated___anon4(t9), new $.init_autogenerated___anon5(t1), null));
    t3 = t1.__stoppers3_2_1_7;
    $.getInterceptor$JSArray(t3).add$1(t3, $.watchAndInvoke(new $.init_autogenerated___anon6(t9), new $.init_autogenerated___anon7(t1, t9), null));
  }
}
};
...
$$.init_autogenerated___anon2 = {"":"Closure;file_7",
 call$0: function() {
  return this.file_7.get$filename();
}
};
...
$$.init_autogenerated___anon3 = {"":"Closure;box_0",
 call$1: function(__e) {
  ...
  this.box_0.__e1_6.set$alt(t1);
}
};

$$.init_autogenerated___anon4 = {"":"Closure;file_8",
 call$0: function() {
  return this.file_8.get$src();
}
};

$$.init_autogenerated___anon5 = {"":"Closure;box_0",
 call$1: function(__e) {
  var t1 = $.sanitizeUri(__e.get$newValue());
  this.box_0.__e1_6.set$src(t1);
}
};

$$.init_autogenerated___anon6 = {"":"Closure;file_9",
 call$0: function() {
  return $.S(this.file_9.get$src());
}
};

$$.init_autogenerated___anon7 = {"":"Closure;box_0,file_10",
 call$1: function(__e) {
  var t1, t2;
  t1 = this.file_10.get$src();
  t2 = this.box_0;
  t2.__binding2_8 = $.updateBinding(t1, t2.__binding2_8, __e.get$newValue());
}
};
...
$$.anon = {"":"Closure;this_0",
 call$1: function(e) {
  var t1 = this.this_0;
  t1._addSelectedFilesToModel$1(t1.get$_fileInput().get$files());
  return;
}
};
...
$$.anon0 = {"":"Closure;this_1",
 call$1: function(e) {
  var t1 = this.this_1.get$_dropZone().get$classes();
  return $.getInterceptor$JSArray(t1).add$1(t1, "hover");
}
};

$$.anon1 = {"":"Closure;this_2",
 call$1: function(e) {
  return this.this_2.get$_dropZone().get$classes().remove$1("hover");
}
};
...
$$.anon2 = {"":"Closure;reader_0,this_1",
 call$1: function(e) {
  var t1, t2;
  t1 = this.reader_0.get$result();
...
$.init_autogenerated = function() {
  var t1, _root, _removeChild__e5, __stoppers1;
  t1 = {};
  _root = $.document().get$body();
  t1.__e5_9 = null;
  _removeChild__e5 = [];
  t1._endPosition__e5_10 = null;
  _root.query$1("#drop-zone");
  _root.query$1("#read").query$1("#file");
  t1.__e5_9 = _root.query$1("#list").query$1("#__e-5");
  __stoppers1 = [];
  t1._endPosition__e5_10 = t1.__e5_9;
  __stoppers1.push($.watchAndInvoke(new $.init_autogenerated_anon(), new $.init_autogenerated_anon0(t1, _removeChild__e5), null));
};
...
$.ConvertedFiles$ = function() {
  return new $.ConvertedFiles($.List_List(null));
};

$.AndroidFile$ = function(_file) {
  var t1 = new $.AndroidFile(_file, null, null, null, null, false);
  t1.AndroidFile$1(_file);
  return t1;
};
...
$.DndFiles$ = function() {
  var t1 = new $.DndFiles(null, null, null);
  t1.DndFiles$0();
  return t1;
};
...
Isolate.$lazy($, 'convertedfiles', 'convertedfiles', 'get$convertedfiles', function() {
...
$.$defineNativeClass('HTMLAppletElement', {"":"alt<,height<,name>,width<"
});
...
$.$defineNativeClass('Element', {"":"$$dom_children:children~,innerHtml:innerHTML|,$$dom_className:className},$$dom_firstElementChild:firstElementChild~,$$dom_lastElementChild:lastElementChild~",
...
$.$defineNativeClass('HTMLImageElement', {"":"alt<,height<,name>,src=,width<"
});

$.$defineNativeClass('HTMLInputElement', {"":"alt<,files>,height<,name>,pattern>,src=,type>,value=,width<",
 get$on: function() {
...
$.$defineNativeClass('Node', {"":"$$dom_attributes:attributes~,$$dom_childNodes:childNodes~,$$dom_localName:localName~,$$dom_namespaceUri:namespaceURI~,nextNode:nextSibling~,parent:parentElement~,previousNode:previousSibling~,text:textContent|",
 get$nodes: function() {
