...
part 'src/model/communication/JsonTO.dart';
part 'src/model/communication/MockREST.dart';
part 'src/model/communication/RealREST.dart';
part 'src/model/communication/RESTFeedbackEvent.dart';
